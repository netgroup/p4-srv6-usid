...
import org.p4.p4d2.srv6_usid.common.Utils;
...
import static org.p4.p4d2.srv6_usid.AppConstants.INITIAL_SETUP_DELAY;
...
public class L2BridgingComponent {
    ...
    private void insertMulticastFlowRules(DeviceId deviceId) {
        ...
        //  Build 2 flow rules.
        final String tableId = "IngressPipeImpl.multicast";
        // ---- END SOLUTION ----
     ...
     */
    private boolean isCore(DeviceId deviceId) {
